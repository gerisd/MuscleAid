...
public class UserExercises_DBHandler extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "SelectedExercises.db";
    private static final String TABLE_NAME = "UsersSelectedExercises";
    ...
    public UserExercises_DBHandler(Context context) {
    ...
    public void insertData(SQLiteDatabase db, String name, String image){
